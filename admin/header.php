    ...
    $html->element("div", array("class" => "sidebar"), array(
        $html->element("div", array("class" => "brand"), array(
            $html->element("a", array("href" => $var->url), array(
                $html->element("img", array("src" => $var->url . "/assets/img/bestplay.png", "alt" => "BESTPLAY", "class" => "img-responsive logo")),
            )),
        )),
        ...
        $html->element("a", array("class" => "footer", "href" => "https://bestplay.me/contact/"), array(
